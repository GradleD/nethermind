...
public class HealingStorageTree : StorageTree
{
    ...
    public HealingStorageTree(ITrieStore? trieStore, Hash256 rootHash, ILogManager? logManager, Address address, Hash256 stateRoot, ITrieNodeRecovery<GetTrieNodesRequest>? recovery, bool detailedLogs = false)
        : base(trieStore, rootHash, logManager, detailedLogs: detailedLogs)
    {
        _address = address;
